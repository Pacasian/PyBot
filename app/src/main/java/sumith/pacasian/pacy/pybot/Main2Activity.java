...
public class Main2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        aiConfiguration = new AIConfiguration("97131800db7046a4ab5e58159ddeed60",AIConfiguration.SupportedLanguages.English,
        ...
        @SuppressLint("StaticFieldLeak") final AsyncTask<String, Void, AIResponse> task = new AsyncTask<String, Void, AIResponse>() {
            ...
            protected void onPostExecute(final AIResponse response) {
                if (response != null) {
                    ...
                    Toast.makeText(Main2Activity.this, "Error dabu", Toast.LENGTH_SHORT).show();
                }
            }
        };
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                switch (metadata.getIntentName()){
                    case "Weather":
                        Toast.makeText(Main2Activity.this, "Hai NO weather", Toast.LENGTH_SHORT).show();;
